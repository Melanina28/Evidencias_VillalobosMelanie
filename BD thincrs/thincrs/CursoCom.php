<?php
    ...
    echo '<table border=1><tr><td>id</td><td>competence_id</td><td>course_id</td></tr>';
    ...
    $sql = "INSERT INTO course_competence (id, competence_id, course_id) VALUES 
    ('$id', '$competence_id', '$course_id')";
